...
export function wasm_bindgen__convert__closures__invoke1_mut__hbdd46349335061b4(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h3a2c30dd8cce216f(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha7f7cb7b70a02a42(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h540cd8646dca92d5(a: number, b: number, c: number): void;
