...
export function wasm_bindgen__convert__closures__invoke1_mut__h412b716e327acb86(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__ha1b6da505e26cbc0(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h06cd64509e0daf62(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he72eacc84ecbbc51(a: number, b: number): void;
