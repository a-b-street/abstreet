...
export function wasm_bindgen__convert__closures__invoke1_mut__h91f1297e82b66450(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h86209491b6e367be(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0205449bf1d28be4(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc8232889d0c1b833(a: number, b: number): void;
