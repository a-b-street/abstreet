...
- Play on
  [Windows](https://github.com/dabreegster/abstreet/releases/download/v0.2.4/abstreet_windows_v0_2_4.zip),
  [Mac](https://github.com/dabreegster/abstreet/releases/download/v0.2.4/abstreet_mac_v0_2_4.zip),
  [Linux](https://github.com/dabreegster/abstreet/releases/download/v0.2.4/abstreet_linux_v0_2_4.zip),
