...
- Play on
  [Windows](https://github.com/a-b-street/abstreet/releases/download/v0.2.32/abstreet_windows_v0_2_32.zip),
  [Mac](https://github.com/a-b-street/abstreet/releases/download/v0.2.32/abstreet_mac_v0_2_32.zip),
  [Linux](https://github.com/a-b-street/abstreet/releases/download/v0.2.32/abstreet_linux_v0_2_32.zip),
