...
sourcesIndex["abstio"] = {"name":"","files":["abst_data.rs","abst_paths.rs","download.rs","io.rs","io_native.rs","lib.rs"]};
sourcesIndex["abstutil"] = {"name":"","files":["cli.rs","collections.rs","lib.rs","logger.rs","process.rs","serde.rs","time.rs","utils.rs"]};
sourcesIndex["augment_scenario"] = {"name":"","files":["augment_scenario.rs"]};
sourcesIndex["clip_osm"] = {"name":"","files":["clip_osm.rs"]};
sourcesIndex["collisions"] = {"name":"","files":["lib.rs"]};
sourcesIndex["convert_osm"] = {"name":"","files":["clip.rs","elevation.rs","extract.rs","lib.rs","osm_geom.rs","parking.rs","reader.rs","snappy.rs","split_ways.rs","transit.rs"]};
...
sourcesIndex["importer"] = {"name":"","files":["berlin.rs","configuration.rs","dependencies.rs","generic.rs","main.rs","seattle.rs","uk.rs","utils.rs"]};
sourcesIndex["json_to_binary_map"] = {"name":"","files":["json_to_binary_map.rs"]};
sourcesIndex["kml"] = {"name":"","files":["lib.rs"]};
sourcesIndex["map_editor"] = {"name":"","files":["edit.rs","main.rs","model.rs","world.rs"]};
sourcesIndex["map_gui"] = {"name":"","dirs":[{"name":"render","files":["agents.rs","area.rs","bike.rs","building.rs","bus_stop.rs","car.rs","intersection.rs","lane.rs","map.rs","mod.rs","parking_lot.rs","pedestrian.rs","road.rs","traffic_signal.rs","turn.rs"]},{"name":"tools","files":["camera.rs","city_picker.rs","colors.rs","command.rs","heatmap.rs","importer.rs","minimap.rs","mod.rs","navigate.rs","turn_explorer.rs","ui.rs","updater.rs","url.rs"]}],"files":["colors.rs","lib.rs","load.rs","options.rs","simple_app.rs"]};
sourcesIndex["map_model"] = {"name":"","dirs":[{"name":"connectivity","files":["mod.rs","walking.rs"]},{"name":"edits","files":["compat.rs","mod.rs","perma.rs"]},{"name":"make","dirs":[{"name":"initial","files":["geometry.rs","lane_specs.rs","mod.rs"]},{"name":"traffic_signals","files":["lagging_green.rs","mod.rs"]}],"files":["bridges.rs","buildings.rs","medians.rs","merge_intersections.rs","mod.rs","parking_lots.rs","remove_disconnected.rs","transit.rs","turns.rs","walking_turns.rs"]},{"name":"objects","files":["area.rs","building.rs","bus_stop.rs","intersection.rs","lane.rs","mod.rs","parking_lot.rs","road.rs","stop_signs.rs","traffic_signals.rs","turn.rs","zone.rs"]},{"name":"pathfind","files":["ch.rs","dijkstra.rs","mod.rs","node_map.rs","pathfinder.rs","uber_turns.rs","vehicles.rs","walking.rs"]}],"files":["city.rs","lib.rs","map.rs","osm.rs","raw.rs","traversable.rs"]};
sourcesIndex["one_step_import"] = {"name":"","files":["one_step_import.rs"]};
sourcesIndex["osm_viewer"] = {"name":"","files":["lib.rs","viewer.rs"]};
sourcesIndex["parking_mapper"] = {"name":"","files":["main.rs","mapper.rs"]};
sourcesIndex["pick_geofabrik"] = {"name":"","files":["pick_geofabrik.rs"]};
...
sourcesIndex["widgetry"] = {"name":"","dirs":[{"name":"geom","files":["geom_batch_stack.rs","mod.rs"]},{"name":"style","files":["button_style.rs","mod.rs"]},{"name":"tools","files":["mod.rs","screenshot.rs","warper.rs"]},{"name":"widgets","files":["autocomplete.rs","button.rs","compare_times.rs","containers.rs","dropdown.rs","fan_chart.rs","filler.rs","image.rs","just_draw.rs","line_plot.rs","menu.rs","mod.rs","panel.rs","persistent_split.rs","plots.rs","scatter_plot.rs","slider.rs","spinner.rs","table.rs","tabs.rs","text_box.rs","toggle.rs"]}],"files":["app_state.rs","assets.rs","backend_glow.rs","backend_glow_native.rs","canvas.rs","color.rs","drawing.rs","event.rs","event_ctx.rs","input.rs","lib.rs","runner.rs","screen_geom.rs","svg.rs","text.rs"]};
