...
- Windows:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.44/abstreet_windows_v0_1_44.zip
- Mac:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.44/abstreet_mac_v0_1_44.zip
- Linux:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.44/abstreet_linux_v0_1_44.zip
