...
- Windows:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.2/abstreet_windows.zip
- Mac:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.2/abstreet_mac.zip
- Linux:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.2/abstreet_linux.zip
