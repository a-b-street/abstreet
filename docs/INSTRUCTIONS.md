...
- Windows:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.28/abstreet_windows_v0_1_28.zip
- Mac:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.28/abstreet_mac_v0_1_28.zip
- Linux:
  https://github.com/dabreegster/abstreet/releases/download/v0.1.28/abstreet_linux_v0_1_28.zip
