...
- [Windows](https://github.com/dabreegster/abstreet/releases/download/v0.2.12/abstreet_windows_v0_2_12.zip)
...
- [Mac](https://github.com/dabreegster/abstreet/releases/download/v0.2.12/abstreet_mac_v0_2_12.zip)
...
- [Linux](https://github.com/dabreegster/abstreet/releases/download/v0.2.12/abstreet_linux_v0_2_12.zip)
  - Unzip the directory, then run `play_abstreet.sh`.
